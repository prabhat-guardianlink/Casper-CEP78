...
const { MASTER_KEY_PAIR_PATH, USER1_KEY_PAIR_PATH, USER2_KEY_PAIR_PATH, MINTER1_KEY_PAER_PATH } =
  process.env;
...
export const MINTER1_KEYS = Keys.Ed25519.parseKeyFiles(
  `${MINTER1_KEY_PAER_PATH}/public_key.pem`,
  `${MINTER1_KEY_PAER_PATH}/secret_key.pem`
);
